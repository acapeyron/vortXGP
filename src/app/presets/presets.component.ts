...
export class PresetsComponent implements OnInit {
  ...
  fillDic(): { [key: string]: [Preset, boolean] } {
    ...
    let p0 = new Preset(this.formatParameters("0",[steady, light, rpm20]), [steady, light, rpm20], "../../assets/videos/presets/isosurface.mp4", "Coucou");
    dic["A0"] = [p0, false];
    let p1 = new Preset(this.formatParameters("1",[steady, medium, rpm20]), [steady, medium, rpm20], "../../assets/videos/presets/isosurface.mp4", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.");
    dic["B1"] = [p1, false];
    let p2 = new Preset(this.formatParameters("2",[steady, advanced, rpm20]), [steady, advanced, rpm20], "../../assets/videos/presets/isosurface.mp4", "Ca");
    dic["C2"] = [p2, false];
    let p3 = new Preset(this.formatParameters("3",[unsteady, light, rpm20]), [unsteady, light, rpm20], "../../assets/videos/presets/isosurface.mp4", "Va");
    dic["D3"] = [p3, false];
    let p4 = new Preset(this.formatParameters("4",[unsteady, medium, rpm20]), [unsteady, medium, rpm20], "../../assets/videos/presets/isosurface.mp4", "Ou");
    dic["E4"] = [p4, false];
    let p5 = new Preset(this.formatParameters("5",[unsteady, advanced, rpm20]), [unsteady, advanced, rpm20], "../../assets/videos/presets/isosurface.mp4", "Quoi");
    dic["F5"] = [p5, false];
    let p6 = new Preset(this.formatParameters("6",[steady, light, rpm72]), [steady, light, rpm72], "../../assets/videos/presets/isosurface.mp4", "Un");
    dic["G6"] = [p6, false];
    let p7 = new Preset(this.formatParameters("7",[steady, medium, rpm72]), [steady, medium, rpm72], "../../assets/videos/presets/isosurface.mp4", "Peu");
    dic["H7"] = [p7, false];
    let p8 = new Preset(this.formatParameters("8",[steady, advanced, rpm72]), [steady, advanced, rpm72], "../../assets/videos/presets/isosurface.mp4", "La");
    dic["I8"] = [p8, false];
    let p9 = new Preset(this.formatParameters("9",[unsteady, light, rpm72]), [unsteady, light, rpm72], "../../assets/videos/presets/isosurface.mp4", "Oh");
    dic["J9"] = [p9, false];
    let p10 = new Preset(this.formatParameters("10",[unsteady, medium, rpm72]), [unsteady, medium, rpm72], "../../assets/videos/presets/isosurface.mp4", "Eh");
    dic["K10"] = [p10, false];
    let p11 = new Preset(this.formatParameters("11",[unsteady, advanced, rpm72]), [unsteady, advanced, rpm72], "../../assets/videos/presets/isosurface.mp4", "Ah");
    dic["L11"] = [p11, false];
